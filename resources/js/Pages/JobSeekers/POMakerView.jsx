...
export default function POMakerView({
    jobSeekers,
    setCounts,
    type,
    employeeCompanyId,
    ...
    const [selectedCompany, setSelectedCompany] = useState(
        selectedCompanyId && companies.find((c) => c.id === selectedCompanyId)
            ...
            : { value: "", label: "All Companies" } // Default to "All Companies"
    );

    const fetchData = useCallback(
        debounce((status, companyId) => {
            router.get(
                route(`job-seekers.${type.toLowerCase()}.index`),
                {
                    ...
                    ...(companyId ? { company_id: companyId } : {}), // Only include company_id if provided
                },
                {
                    preserveState: true,
                    preserveScroll: true,
    ...
    const handleCompanyChange = (selectedOption) => {
        ...
        setPage(1);
        fetchData(statusFilter, selectedOption?.value);
    };
                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-6">
                                <h4 className="card-title">
                                    {type} Job Seekers List (PO Maker)
                                </h4>
                            </div>
            ...
            {selectedJobSeeker && (
                <ViewModal
                    ...
                    showActions={(jobSeeker) =>
                        ...
                        jobSeeker.process_status === 3 &&
                        employeeId === jobSeeker.po_checker_id
                    }
                    onActionSuccess={() => {
                        setSelectedJobSeeker(null);
                        fetchData(statusFilter);
